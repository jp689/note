"""
Legacy in-memory store for demo/testing.

This module is NOT used in production. The production code uses SQLAlchemy
with the User/Document/KnowledgeNode models in models.py and security.py.

The hash_password function here uses simple SHA-256, which is intentionally
different from the PBKDF2-SHA256 used in security.py. This is acceptable
because this store is only for local demo purposes.

For production password hashing, see security.py which uses PBKDF2-SHA256
with 120,000 iterations.
"""
...
class StudyStore:
    ...
    def hash_password(password: str) -> str:
        """
        Simple SHA-256 hash for demo store only.

        WARNING: This is NOT secure for production use.
        Use security.hash_password() which uses PBKDF2-SHA256 with 120,000 iterations.
        """
